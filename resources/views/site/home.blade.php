                  ...
                  <article>
                      ...
                      <div class="post-header">
                          ...
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                  href="{{ route('news2') }}">İstanbul Üniversitesi ile Gülşen Kılıç Üniversitesi
                                  Arasında
              ...
              <div class="item">
                  <article>
                      ...
                      <div class="post-header">
                          ...
                          <!-- /.post-category -->
                          <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark"
                                  href="{{ route('news4') }}">Mühendislik Fakültesi Öğretim Üyelerimiz “Kimya Bilimine
                                  Yön
                    ...
                    <div class="row">
                        <div class="col-xl-10 mx-auto">
                            <div class="row align-items-center counter-wrapper gy-6 text-center">
                                <div class="col-md-3">
                                    <img src="site/images/about/check.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3"
                                        alt="" />
                                ...
                                <!--/column -->
                                <div class="col-md-3">
                                    <img src="site/images/about/user.svg" class="svg-inject icon-svg icon-svg-lg text-primary mb-3"
                                        alt="" />
