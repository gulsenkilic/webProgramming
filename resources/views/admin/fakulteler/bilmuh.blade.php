    ...
    <div class="card py-3 mt-10">
        <div class="card border-dark  ">
            <div class="card-header">
                <p class="pt-7 text-primary"><b>MUHENDİSLİK FAKULTESİ -- BİLGİSAYAR MUHENDİSLİĞİ BÖLÜMÜ </b></p>
                <a type="button" class="btn btn-warning h-75 mt-4" href='{{ route('fakulteBolumler') }}'>GERİ DÖN</a>
