...
@section('content')
    <div class="card py-3 mt-10">
        <div class="card border-dark  ">
            <div class="card-header">
                <p class="pt-7 text-primary"><b>MÜHENİSLİK FAKÜLTESİ </b></p>
                <a type="button" class="btn btn-warning h-75 mt-4" href='{{ route('fakulteler') }}'>GERİ DÖN</a>
    ...
    <div class="card py-3 mt-10">
        <div class="content-container">
            ...
            <div class="card border-dark mb-3 ">
                <div class="card-header">
                    <p class="pt-7 text-primary"><b><a href="{{ route('fakulteBolumler') }}">BÖLÜMLER</a> </b></p>
                    <a type="button" class="btn btn-primary h-100 mt-4" href='{{ route('akademikEkle') }}'>YENI BÖLÜM EKLE</a>
                </div>
